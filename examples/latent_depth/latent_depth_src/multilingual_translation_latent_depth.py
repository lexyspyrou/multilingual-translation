...
#
# from .loss.latent_depth import LatentLayersKLLoss
# from .loss.latent_depth import LatentLayersSparsityLoss
#
#
...
#             print(type(model.models[lang_pair].decoder).__name__)
#             print(type(model.models[lang_pair].encoder).__name__)
